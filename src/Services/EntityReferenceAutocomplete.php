...
class EntityReferenceAutocomplete extends EntityAutocompleteController {
  
  function handleAutocompleteCustom(Request $request, $target_type, $selection_handler, $selection_settings_key) {
    $matches = [];
